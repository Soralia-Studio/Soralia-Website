...
export default function SocialMediaButtons({ 
    ...
    const socialLinks = [
        {
            name: 'Facebook',
            url: 'https://www.facebook.com/SoraliaStudio',
            icon: (
        ...
        {
            name: 'YouTube',
            url: 'https://www.youtube.com/@SoraliaStudio',
            icon: (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    {/* Toggle Circle - Half size, D-shape */}
                    <div style={{
                        position: 'absolute',
                        top: '3px',
                        left: language === 'en' ? '3px' : 'calc(100% - 38px)',
                        width: '35px',
                        height: '30px',
                        background: 'white',
                        borderRadius: language === 'en' ? '15px 2px 2px 15px' : '2px 15px 15px 2px',
