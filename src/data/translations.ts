...
export const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'home.description': 'We organize rhythm game tournaments and creative events',
    ...
    vi: {
        ...
        'home.description': 'Chúng tôi tổ chức các giải đấu rhythm game và sự kiện sáng tạo',
